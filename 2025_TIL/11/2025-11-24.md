...
- 학습 목표 4: RNN/LSTM -> transformer 모델, 장기 의존성 문제 블로그에 업로드하기.
...
### 주제 3: RNN/LSTM -> transformer 모델, 장기 의존성 문제 블로그에 업로드하기.
- **RNN/LSTM/GRU의 장기 의존성 문제 plot 하기**:

실험 조건: embed_dim = 8, hidden_size = 16, seq_len = 15으로 통일하여 그래프를 그렸습니다. 

<img width="1183" height="548" alt="image" src="https://github.com/user-attachments/assets/f5b34265-0f14-4e18-af91-9ef56f4dfafb" />
